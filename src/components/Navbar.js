...
export default function Navbar({
	...
	return (
		<div className="fixed top-0 left-0 z-50 flex h-24 w-full items-center justify-between border-b border-gray-500 bg-black p-4 text-white lg:p-8">
			<a
				href="#aboutme"
			...
			<ul className="hidden gap-2 lg:flex lg:gap-20">
