	...
	return (
		...
		>
			...
			<div className="absolute top-0 left-0 z-30 h-full w-full bg-[#00000080] opacity-0 transition-all group-hover:opacity-100">
				<div>
					<span
						style={{ clipPath: "polygon(0 0, 100% 0, 100% 21%, 0% 100%)" }}
						className="absolute left-0 top-0 h-1/2 w-full rounded bg-[#f59e0be6] pl-2 text-3xl font-bold tracking-normal text-gray-100"
					>
						{name || "Name"}
					</span>
					<div
					...
					>
						<a
							href={link || "#"}
							className="absolute right-2 bottom-2 h-10 w-10 fill-white"
						>
